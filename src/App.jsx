...
function App() {
  ...
  const variables = {
    ...
    '--glitch-band-one-y': `${16 + ((experience.signal.variant * 13) % 56)}%`,
    '--glitch-band-two-y': `${28 + ((experience.signal.variant * 19) % 48)}%`,
    '--glitch-grid-shift': `${(experience.signal.variant % 17) - 8}px`,
